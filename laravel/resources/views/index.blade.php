...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../public_html/assets/vendors/linericon/style.css">
        <link rel="stylesheet" href="../public_html/assets/css/font-awesome.min.css">
        <link rel="stylesheet" href="../public_html/assets/vendors/owl-carousel/owl.carousel.min.css">
        <link rel="stylesheet" href="../public_html/assets/vendors/lightbox/simpleLightbox.css">
        <link rel="stylesheet" href="../public_html/assets/vendors/nice-select/css/nice-select.css">
        <link rel="stylesheet" href="../public_html/assets/vendors/animate-css/animate.css">
        <link rel="stylesheet" href="../public_html/assets/vendors/popup/magnific-popup.css">
        <link rel="stylesheet" href="../public_html/assets/vendors/flaticon/flaticon.css">
        <!-- main css -->
            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<a class="navbar-brand logo_h" href="index.html"><img src="../public_html/assets/img/logo.png" alt=""></a>
           	...
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img src="../public_html/assets/img/personal.jpg" alt="">
							</div>
